...
def one_epoch(model: nn.Module, dataloader: DataLoader, optimiser: optim.Optimizer, loss_fn, silent=True):
...
def find_lr(
    ...
    for epoch in range(epochs):
        ...
        train_loss = epoch_fn(model, train_dataloader, optimiser, loss_fn, silent=silent)
...
def fit(
    ...
    for epoch in range(epochs):
        train_loss = one_epoch(model, train_dataloader, optimiser, loss_fn, silent=silent)
